class arcDiagram {
    ...
    initVis() {
        ...
        const width = (nodes.length - 1) * step + marginTop + marginBottom;
        const y = d3.scalePoint(d3.sort(nodes.map((d) => d.id)), [marginTop, height - marginBottom]);
        ...
        label.append("rect")
            ...
            .on("pointerenter", (event, d) => {
                ...
                label.classed("secondary", n => arcDiagramData.some(({source, target}) => (
